...
char *id_dict[ID_NUM] = {
    ...
    "💊", // 13:碰触蛇身不死亡，改为清除之，并根据减少的长度，减少2/3分数.只能储存一次
    "🆙", // 14:分数翻倍
    "☢️"   // 15:结束游戏，清除记录，然后让你的计算机在5秒内关机。生成16游戏刻后消失
};

const int entity_limit_init[ID_NUM + 1] = {
    -1, // 0
    -1, // 1
    -1, // 2
    -1, // 3
